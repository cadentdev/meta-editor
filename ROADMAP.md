...
- [ ] Separate Ollama URL into separate fields to improve data validation
- [ ] Create a Results field to display the results of interations with the LLM on the main interface page
